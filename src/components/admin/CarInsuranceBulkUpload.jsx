...
const CarInsuranceBulkUpload = ({ onClose, onSuccess, defaultPolicyType }) => {
    ...
    const downloadTemplate = () => {
        ...
        // Create a proper CSV with quoted fields to handle commas
        const sampleData = [
            ...
            '18',
            '75',
            'Comprehensive car insurance coverage with zero depreciation',
            'Sample Car Insurer',
            'https://example.com/logo.png',
            'Zero Depreciation|Roadside Assistance|Engine Protect',
            'Quick Claims|24x7 Support|Cashless Garages',
            'Wear and Tear|Mechanical Breakdown|Normal Depreciation',
            'Registration Certificate|Insurance Certificate|Driving License',
            'true',
            'false',
            '10',
            '0',
        ...
        link.href = url;
        link.download = 'car_insurance_template.csv';
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await fetch('/api/car-insurance/policies/bulk-upload', {
                method: 'POST',
                body: formData
            });
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-auto">
                <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-2xl font-bold text-gray-800">Bulk Upload Car Insurance</h2>
                        <button
                            onClick={onClose}
...
export default CarInsuranceBulkUpload;

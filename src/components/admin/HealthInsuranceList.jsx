...
const HealthInsuranceList = ({ onEditPolicy, onViewPolicy, refreshTrigger }) => {
    ...
    const fetchPolicies = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(`/api/health-insurance/policies?${params}`);
    ...
    }, [currentPage, debouncedSearchTerm, policyTypeFilter, statusFilter, companyFilter, roomRentFilter, restorationFilter, refreshTrigger, itemsPerPage]);
    ...
    const handleToggleStatus = async (policyId) => {
        try {
            const response = await fetch(`/api/health-insurance/policies/${policyId}/toggle-status`, {
                method: 'PATCH',
                headers: {
    ...
    const handleTogglePopular = async (policyId) => {
        try {
            const response = await fetch(`/api/health-insurance/policies/${policyId}/toggle-popular`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                }
    ...
    const handleDeletePolicy = async (policyId) => {
        ...
        try {
            const response = await fetch(`/api/health-insurance/policies/${policyId}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                }
        ...
        <div className="bg-white rounded-lg p-6">
            <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-medium text-black">Health Insurance Policies ({totalItems})</h3>
                    {loading && (
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20 mb-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Restoration</label>
                            <select
                ...
                <div className="text-sm text-gray-600 mb-4">
                    Showing {policies.length} of {totalItems} health insurance policies
                </div>
            </div>
                        ...
                        {loading && policies.length === 0 ? (
                            ...
                            <tr>
                                <td colSpan="6" className="px-6 py-12 text-center text-gray-500">
                                    No health insurance policies found. Try adjusting your search criteria.
                                </td>
                            </tr>
                        ) : (
                            policies.map((policy) => (
...
HealthInsuranceList.displayName = 'HealthInsuranceList';

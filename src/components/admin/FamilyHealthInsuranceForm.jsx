...
const FamilyHealthInsuranceForm = ({ policy, onClose, onSaved }) => {
    const [formData, setFormData] = useState({
        ...
        reviews: 0,
        tags: [''],
        // Family health insurance specific fields
        cashlessHospitals: 0,
        ...
        childCoverAge: 25,
        parentCoverAge: 65,
        familyFloaterBenefit: true,
        individualDeductible: false
    });
    ...
    useEffect(() => {
        if (policy) {
            setFormData({
                ...
                // Handle family health insurance specific fields with defaults
                ...
                maxFamilyMembers: policy.maxFamilyMembers || 6,
                childCoverAge: policy.childCoverAge || 25,
                parentCoverAge: policy.parentCoverAge || 65,
                familyFloaterBenefit: policy.familyFloaterBenefit !== undefined ? policy.familyFloaterBenefit : true,
                individualDeductible: policy.individualDeductible || false
            });
        }
    }, [policy]);
    ...
    const validateForm = () => {
        ...
        if (formData.maxFamilyMembers < 2) {
            newErrors.maxFamilyMembers = 'Maximum family members must be at least 2';
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = policy 
                ? `/api/family-health-insurance/policies/${policy._id}`
                : '/api/family-health-insurance/policies';
            ...
            <div className="p-6">
                {/* <div className="flex justify-between items-center mb-6">
                    <h3 className="text-lg font-medium text-black">
                        {policy ? 'Edit Family Health Insurance Policy' : 'Add New Family Health Insurance Policy'}
                    </h3>
                    <button
                        onClick={onClose}
                ...
                <div className="border-b pb-6">
                    ...
                    <div className="mt-6">
                        ...
                        <textarea
                            ...
                            rows="4"
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                            placeholder="Enter detailed description of the family health policy"
                        />
                        {errors.description && (
                ...
                {/* Family Health Insurance Specific Fields */}
                <div className="border-b pb-6">
                    <h4 className="text-md font-medium text-black mb-4">Family Health Insurance Specific</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label className="block text-sm font-medium text-black mb-2">
                            ...
                            <input
                                ...
                                required
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Maximum number of family members"
                                min="2"
                                max="8"
                            />
                            {errors.maxFamilyMembers && (
                                <p className="text-red-500 text-sm mt-1">{errors.maxFamilyMembers}</p>
                            )}
                        </div>

                        <div>
                            <label className="block text-sm font-medium text-black mb-2">
                                Child Cover Until Age
                            </label>
                            <input
                                type="number"
                                name="childCoverAge"
                                value={formData.childCoverAge}
                                onChange={handleInputChange}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Child cover until age"
                                min="18"
                                max="30"
                            />
                        </div>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-black mb-2">
                                Parent Cover Until Age
                            </label>
                            <input
                                type="number"
                                name="parentCoverAge"
                                value={formData.parentCoverAge}
                                onChange={handleInputChange}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Parent cover until age"
                                min="60"
                                max="80"
                            />
                        </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <label className="flex items-center space-x-2">
                                <input
                                    type="checkbox"
                                    name="familyFloaterBenefit"
                                    checked={formData.familyFloaterBenefit}
                                    onChange={handleInputChange}
                                    className="form-checkbox h-4 w-4 text-blue-600"
                                />
                                <span className="text-sm text-black">Family Floater Benefit</span>
                            </label>
                            ...
                            <label className="flex items-center space-x-2">
                                <input
                                    ...
                                    checked={formData.individualDeductible}
                                    onChange={handleInputChange}
                                    className="form-checkbox h-4 w-4 text-blue-600"
                                />
                                <span className="text-sm text-black">Individual Deductible</span>
                            </label>
...
FamilyHealthInsuranceForm.displayName = 'FamilyHealthInsuranceForm';

export default FamilyHealthInsuranceForm;
...
const BikeInsuranceForm = ({ policy, onClose, onSaved }) => {
    const [formData, setFormData] = useState({
        ...
        reviews: 0,
        tags: [''],
        // Bike insurance specific fields
    ...
    useEffect(() => {
        if (policy) {
            setFormData({
                ...
                // Handle bike insurance specific fields with defaults
                engineCapacity: policy.engineCapacity || '75cc-to-150cc',
                bikeType: policy.bikeType || 'motorcycle',
                zeroDepreciationCover: policy.zeroDepreciationCover || false,
                roadsideAssistance: policy.roadsideAssistance !== undefined ? policy.roadsideAssistance : true,
                engineProtect: policy.engineProtect || false,
                personalAccidentCover: policy.personalAccidentCover !== undefined ? policy.personalAccidentCover : true,
                medicalExpenses: policy.medicalExpenses !== undefined ? policy.medicalExpenses : true,
                accessoriesCover: policy.accessoriesCover || false,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = policy 
                ? `/api/bike-insurance/policies/${policy._id}`
                : '/api/bike-insurance/policies';
    ...
    return (
        <div className="bg-white rounded-lg max-h-full overflow-y-auto">
            <div className="p-6">
                ...
                {/* Bike Insurance Specific Fields */}
                <div className="border-b pb-6">
                    <h4 className="text-md font-medium text-black mb-4">Bike Insurance Specific</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label className="block text-sm font-medium text-black mb-2">
                                Engine Capacity
                    ...
                    <div className="mt-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <label className="flex items-center space-x-2">
                                <input
                                    type="checkbox"
                                    name="zeroDepreciationCover"
                                    checked={formData.zeroDepreciationCover}
                                    onChange={handleInputChange}
                                    className="form-checkbox h-4 w-4 text-blue-600"
                                />
                                <span className="text-sm text-black">Zero Depreciation Cover</span>
                            </label>
                            ...
                            <label className="flex items-center space-x-2">
                                <input
                                    ...
                                    className="form-checkbox h-4 w-4 text-blue-600"
                                />
                                <span className="text-sm text-black">Roadside Assistance</span>
                            </label>
                            ...
                            <label className="flex items-center space-x-2">
                                <input
                                    type="checkbox"
                                    name="engineProtect"
                                    checked={formData.engineProtect}
                                    onChange={handleInputChange}
                                    className="form-checkbox h-4 w-4 text-blue-600"
                                />
                                <span className="text-sm text-black">Engine Protect</span>
                            </label>
                            ...
                            <label className="flex items-center space-x-2">
                                <input
                                    ...
                                    checked={formData.personalAccidentCover}
                                    onChange={handleInputChange}
                                    className="form-checkbox h-4 w-4 text-blue-600"
                                />
                                <span className="text-sm text-black">Personal Accident Cover</span>
                            </label>
                            ...
                            <label className="flex items-center space-x-2">
                                <input
                                    ...
                                    className="form-checkbox h-4 w-4 text-blue-600"
                                />
                                <span className="text-sm text-black">Medical Expenses</span>
                            </label>

                            <label className="flex items-center space-x-2">
                                <input
                                    type="checkbox"
                                    name="accessoriesCover"
                                    checked={formData.accessoriesCover}
                                    onChange={handleInputChange}
                                    className="form-checkbox h-4 w-4 text-blue-600"
                                />
                                <span className="text-sm text-black">Accessories Cover</span>
                            </label>
                        </div>
                    </div>
                </div>
...
BikeInsuranceForm.displayName = 'BikeInsuranceForm';

...
export default function Checkconfirmation({ confirtfirstData, confirmpageData, insurancePlanData, addonBenefitsData, userData: contextUserData }) {
        ...
        <div className="max-h-screen bg-white flex flex-col items-center py-8 px-2">
          ...
          <div className="bg-white shadow-md rounded-xl w-full max-w-3xl px-6 py-7 flex flex-col gap-8 border">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-4">
                <InfoRow label="Selected Plan" value={combinedUserData?.selectedPlan || "ICICI Pru iProtect Smart"} />
                <InfoRow label="Life Cover" value="₹ 3 Crores" />
                <InfoRow label="Policy Term" value="32 Years" />
                <InfoRow label="Mode Of Premium Payment" value="Yearly" />
              </div>
            </section>
            {/* Checkbox Options */}

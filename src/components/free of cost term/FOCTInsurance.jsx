        ...
        try {
            await fetch('/api/inquiries/create', {
                ...
                body: JSON.stringify({
                    ...
                    subject: 'Free Term Plan Inquiry',
            ...
            // continue navigation even if inquiry creation fails
        } finally {
            setSubmitting(false);
            navigate('/foct-policy', { state: { formData } });
        }
    };
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-lg">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 ">
                            ...
                            <button
                                type="submit"
                                disabled={submitting}
                                className={`mx-auto block w-40 text-white py-2 rounded-lg text-base transition-colors ${submitting ? 'bg-blue-300' : 'bg-blue-600 hover:bg-blue-700'}`}
                            >
                                {submitting ? 'Submitting...' : 'View Plans Quotes'}
                            </button>
...
FOCTInsurance.displayName = "FOCTInsurance";

export default FOCTInsurance; 
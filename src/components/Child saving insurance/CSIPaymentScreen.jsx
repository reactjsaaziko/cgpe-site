...
const CSIPaymentScreen = () => {
    ...
    const csiData = location.state?.csiData || {
        initialFormData: {},
        yourDetailsFormData: {
            firstName: 'Sasasa Asas',
            email: 'Aaziko@Gmail.Com',
            gender: 'Female',
            dateOfBirth: '01/01/1995'
        },
        planData: {
            selectedPlan: 'Child Capital Goal Suraksha',
            investmentAmount: '2,200 Monthly',
            payFor: '08 Years',
            withdrawAfter: '15 Years'
        }
    };
    ...
    const banks = [
        { id: 'hdfc', name: 'HDFC BANK', logo: '/assets/images/HDFC_Life_logo.png.png' },
        { id: 'axis', name: 'AXIS BANK', logo: '/assets/images/HSBC_logo.png.png' },
        { id: 'sbi', name: 'State Bank of India', logo: '/assets/images/SBI_logo.png.png' },
        { id: 'icici', name: 'ICICI Bank', logo: '/assets/images/ICICI_logo.png.png' }
    ];
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="bg-[#f8fafc] max-h-screen py-8 px-4">
                {/* Header */}
                ...
                {/* Main content */}
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-7 my-10">
                ...
                `}
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-7 mt-10 text-blue-600 text-[15px]">
                            ...
                            <a href="#" className="hover:underline">How CSI Works?</a>
                        </div>
                    </div>
                    ...
                    <div className="w-full md:w-[500px] flex flex-col gap-6">
                        ...
                        <div className="bg-white rounded-xl shadow-md border border-gray-200 px-6 py-4 mb-4">
                            ...
                            <div className="flex items-center mb-2">
                                ...
                                <span className="text-[15px] font-medium">{csiData.yourDetailsFormData?.email || 'Aa**Ko@Gmail.Com'}</span>
                            </div>
                            <div className="flex items-center">
                        ...
                        <div className="bg-white rounded-xl shadow-md border border-gray-200 px-6 py-4">
                            <div className="flex justify-between mb-1">
                                ...
                                <div className="text-gray-500 text-sm">Order No. CSI80234446</div>
                            </div>
                            <div className="flex items-center gap-2 mt-2 mb-1">
                                ...
                                <div className="font-semibold text-[15px] text-[#283356]">
                                    {csiData.planData?.selectedPlan || 'Child Capital Goal Suraksha'}
                                </div>
                            </div>
                            <div className="grid grid-cols-3 text-[15px] mb-2 mt-3">
                                <div>
                                    <div className="text-gray-500 text-xs">Plan Type</div>
                                    <div className="font-bold">Child Saving</div>
                                </div>
                                <div>
                                    <div className="text-gray-500 text-xs">Proposal No.</div>
                                    <div className="font-bold">CSI00654621</div>
                                </div>
                                <div>
...
export default CSIPaymentScreen;

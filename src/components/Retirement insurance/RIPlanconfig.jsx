...
export default function RIPlanconfig() {
  ...
  const handleNextClickNavigate = () => {
    navigate("/retirement-review-details");
  };
          ...
          <div className="bg-white rounded-xl shadow p-8 flex-1 flex flex-col gap-2 min-w-[360px]">
            ...
            <form className="flex flex-col gap-4">
              <div>
                ...
                <input type="text" placeholder="Enter your full name" className="w-full border-b border-gray-300 outline-none py-2 text-gray-700 bg-transparent"/>
              </div>
              ...
              <div>
                ...
                <input type="text" placeholder="Enter your mobile number" className="w-full border-b border-gray-300 outline-none py-2 text-gray-700 bg-transparent"/>
              </div>
              <div>
                <label className="block text-gray-600 text-sm mb-1">Email Address</label>
                <input type="email" placeholder="Enter your email address" className="w-full border-b border-gray-300 outline-none py-2 text-gray-700 bg-transparent"/>
              </div>
              <div>
            ...
            <div className="flex items-center justify-between gap-4 mt-8 bg-[#f5f8fd] rounded-lg px-6 py-4 border-t">
              ...
              <button 
                onClick={handleNextClickNavigate}

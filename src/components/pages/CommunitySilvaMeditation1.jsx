...
import sm1 from '../../assets/2022sm1.png';
import sm2 from '../../assets/2022sm2.png';
import videoSrc from '../../assets/2022sm.mp4';
        ...
        <div style={{ marginBottom: '48px' }}>
          ...
          <h2 className="ch-detail-h2">
            <span className="ch-primary-text">
              {t('silvaMeditationSession1', language)}
            </span>
          </h2>
...
export default CommunitySilvaMeditation1;

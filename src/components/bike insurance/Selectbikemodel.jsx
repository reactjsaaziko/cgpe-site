...
import SelectBikeVariant from "./SelectBikeVariant";

export default function SelectBikeModel({ selectedBrand = "Maruti" }) {
    ...
    const popularModels = [
        // First section
        "Activa", "CB Shine", "CB Unicon", "Aviator",
        "Dio", "Dream Yuga", "CB 300R", "Hornet 2.0",
        // Second section
        "CB", "Shine", "Unicon", "CB Twister",
        "Sp", "Hness", "X - Blade", "Active i"
    ];
    ...
    if (showVariantSelection) {
        return (
            <SelectBikeVariant 
                ...
                onBack={() => setShowVariantSelection(false)}
            />
        );
    }

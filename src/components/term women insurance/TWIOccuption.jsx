...
const OccupationForm = ({ formData, updateFormData, errors, onNext, onPrev }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-md mx-auto text-center w-[600px] mt-14">
      ...
      {/* Heading */}
      <h2 className="text-lg font-medium my-5">Please Choose your occupation type</h2>

      {/* Buttons */}
      <div className="flex flex-col justify-center gap-4 mb-11">
        <button
          type="button"
        ...
        <button
          type="button"
          onClick={() => handleOccupationChange('Housewife')}
          className={`px-6 py-2 rounded-md border font-medium transition ${

...
export default function TWIPolicy() {
    ...
    useEffect(() => {
        const fetchPolicies = async () => {
            try {
                ...
                // Only fetch Term Women Insurance policies
                params.append('policyType', 'term-women');
            ...
            <div className="w-full flex flex-col gap-3 max-w-5xl mx-auto pt-6">
                ...
                {formData ? (
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                        ...
                        <button 
                            onClick={() => window.location.href = '/women-insurance'}
                ...
                <div className="text-center py-12">
                    ...
                    {formData && (
                        <button 
                            onClick={() => {
                                localStorage.removeItem('termInsuranceFormData');
                                window.location.href = '/women-insurance';
                            }}
...
TWIPolicy.displayName = "TWIPolicy";
